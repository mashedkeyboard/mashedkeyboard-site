...
export async function load() {
    return {
        ...
        has_own_h1: true,
        description: "A collection of Curtis Parfitt-Ford's thoughts on tech and society. No promises as to how often it's updated, but hopefully vaguely interesting when it is."
    };
  }