...
<section class="intro">
	...
	<p>
		...
		across pre-hospital emergency care, web software engineering, and human-computer interaction. Much
		as that's an unusual set of words to put together, the breadth of my experience means I'm able to
...
<div class="cv">
	<section class="places">
		...
		<details>
			...
			<p>
				...
				technology, in particular in the third sector and civic technology spaces. I started as the
				only in-house software engineer, with responsibilities including building and maintaining
				systems that manage campaign data, architecting data models for the storage of
				authentication and contact information, managing the deployment of internal and external
				systems into the AWS cloud, and writing internal documentation for contracted technology
				partners.
			</p>
			<p>
		...
		<details>
			...
			<p>
				...
				developing with Ruby on Rails, PostgreSQL and Redis, among various other technologies.
			</p>
			<p>
				In terms of soft skills, I also overcame significant adversity in the process of founding
		...
		<details>
			...
			<p>
				...
				systems combating cybercrime, as well as exploring ways to work with both government
				agencies and upstream providers to take fraudulent content offline, protecting brands and
				consumers alike.
			</p>
		</details>
		<details>
			...
			<p>
				...
				awarded “Young Activist of the Year”, I gained some fascinating insights into corporate and
				commercial law, as well as opportunities to network with leading industry professionals
				&mdash; including from a selection of Clifford Chance clients, who presented to us during
				the scheme.
			</p>
		</details>
	</section>
	...
	<section class="volunteering">
		...
		<details>
			...
			<p>
				St John Ambulance is England's largest first aid charity, providing medical cover at events,
				in communities, and in response to emergency calls in partnership with the NHS. From 2022 to
				2025, we served as England's national Ambulance Auxiliary, meaning supporting pre-hospital
				emergency care delivery across NHS ambulance services all year round.
			</p>
			<p>
				I qualified as an Emergency Ambulance Crew with St John in October 2022. Since then, I've
				worked on double-staffed ambulances in SWAST, SCAS, IOWAS and EMAS trusts. I've also formed
				part of the medical team at a variety of significant events, ranging from Manchester and
				Brighton Prides to the Great North Run and London Marathon, working alongside other
				healthcare professionals and providing leadership and mentorship to junior members of the
				team, such as our first aiders.
			</p>
			<p>
				I regularly teach university First Aid Societies and other community groups as part of this
				role, differentiating content across an audience ranging from laypeople and schoolchildren
				to final-year medical students. I am also a qualified Cycle Responder, providing a
				fast-response capability to large events, with the ability to triage and treat patients
				without requiring a double-staffed ambulance response.
			</p>
		</details>
		<details>
			<summary>
		...
		<details>
			...
			<p>
				St John Ambulance is England's largest first aid charity, providing medical cover at events,
				in communities, and in response to emergency calls in partnership with the NHS. Student
				Volunteering Units in St John act as regular Event Services Units, and are trained and run
				to the same standard as any other adult unit.
			</p>
			<p>
				...
				John, and ensuring we appropriately staffed our events. I was also responsible for the
				operational management of volunteers, together with the Unit Manager and Unit Training Lead.
			</p>
			<p>
				In this role, my team and I grew our unit from a handful of volunteers to more than twenty,
				and successfully planned and delivered medical cover at numerous different events
				independently. This included Night-Time Economy medical provision in Southampton, providing
				out-of-hospital urgent and emergency care to service users overnight, preventing pressure on
				the statutory ambulance service and hospitals.
			</p>
		</details>
		<details>
			<summary>
			...
			<p>
				...
				infrastructure, but also for data protection, which is critically important in a society for
				GSM students.
			</p>
			<p>
				As well as designing a new authentication system in PHP and Discord bot in Go,
				I worked directly with the Students' Union's leadership to create appropriate technical and
				organisational measures to protect members' data, establish the Society's legal relationship
				with the Union, and investigate options to inject member data into insurance "pools" without
	...
	<section class="qualifications">
		<h3>Qualifications <FaIcon icon={faBuildingColumns} /></h3>
		<div>
			<section class="flex-100">
				<h4>York St John University</h4>
				<section>
					<p>MSc Paramedic Science (Pre-Registration)</p>
					<p>Graduating July 2026 - on track for Distinction</p>
					<aside>
						<h6>Including level 7 modules in</h6>
						<ul>
							<li>Paramedic Research in Action</li>
							<li>Urgent and Primary Care for Paramedic Practice</li>
							<li>Concepts of Physical and Mental Health in Paramedic Practice</li>
						</ul>
					</aside>
				</section>
			</section>
	...
	<section class="references">
		<h3><FaIcon icon={faMessage} /> References</h3>
